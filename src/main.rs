...
fn apply_layout(title: &str, content: &str) -> String {
    ...
    format!(
        ...
        <body>
            ...
            <footer>
                All articles are automatically generated by a LLM (Large Language Model like GPT-4 or Claude). It can contain hallucinations, nonsense, factual errors, and other inaccuracies. Do not take it seriously in any way. <a href="https://github.com/syeo66/autoblogger">Source on Github</a>
            </footer>
        </body>
        </html>
        "#,
